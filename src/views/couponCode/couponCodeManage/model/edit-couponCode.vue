        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="券码" prop="couponCode">
              <el-input v-model="postData.couponCode"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="代理商" prop="agentCode">
              <el-select v-model="postData.agentCode" style="width: 100%">
          ...
          <el-col :span="8">
            <el-form-item label="适用分公司" prop="applicableBranch">
              <el-select v-model="postData.applicableBranch" multiple style="width: 100%">
          ...
          <el-col :span="8">
            <el-form-item label="券码类型" prop="couponType">
              <el-select v-model="postData.couponType" style="width: 100%">
          ...
          <el-col :span="8">
            <el-form-item label="领用人" prop="receiverName">
              <el-input v-model="postData.receiverName"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="领用人openId" prop="receiverOpenId">
              <el-input v-model="postData.receiverOpenId"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="领用人电话" prop="receiverMobile">
              <el-input v-model="postData.receiverMobile" style="background: #FFFFFF !important;"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="是否领用" prop="isReceive">
              <el-select v-model="postData.isReceive" style="width: 100%">
          ...
          <el-col :span="8">
            <el-form-item label="是否使用" prop="isUse">
              <el-select v-model="postData.isUse" style="width: 100%">
          ...
          <el-col :span="8">
            <el-form-item label="是否有效" prop="validStatus">
              <el-select v-model="postData.validStatus" style="width: 100%">
          ...
          <el-col :span="8">
            <el-form-item label="导入人代码" prop="importCode">
              <el-input v-model="postData.importCode" style="background: #FFFFFF !important;"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="领用人证件号" prop="receiverIdentifiedno">
              <el-input v-model="postData.receiverIdentifiedno" style="background: #FFFFFF !important;"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="使用门店" prop="useStores">
              <el-input v-model="postData.useStores" style="background: #FFFFFF !important;"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="批次号" prop="batchId">
              <el-input v-model="postData.batchId" style="background: #FFFFFF !important;"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="导入时间" prop="importTime">
              <el-date-picker v-model="postData.importTime" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" style="width: 100%"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="有效期始" prop="startTime">
              <el-date-picker v-model="postData.startTime" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" style="width: 100%"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="有效期止" prop="endTime">
              <el-date-picker v-model="postData.endTime" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" style="width: 100%"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="领用时间" prop="receiveTime">
              <el-date-picker v-model="postData.receiveTime" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" style="width: 100%"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="使用时间" prop="useTime">
              <el-date-picker v-model="postData.useTime" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" style="width: 100%"></el-date-picker>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
